...
function fetchPets(e) {
  ...
  (0, _fetchJsonp.default)("http://api.petfinder.com/pet.find?format=json&key=8a6ac978d2a377461f8bd155f85c4dd7&".concat(animal, "&location=").concat(zip, "&callback=callback"), {
